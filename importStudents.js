...
const STUDENTS = [
  ...
  { student_id: 'PW/VSP/LENDI/IN/029', name: 'Chelluri Lalitha Madhuri',                     father_name: 'Chelluri Srinivasa Rao',     internship_domain: 'AWS IoT Cloud Engineering' },
  { student_id: 'PW/VSP/LENDI/IN/030', name: 'Bulli Tim Kumar',                              father_name: 'Bulli Appala Naidu',         internship_domain: 'Google Data Analytics' },
];
...
async function run() {
  ...
  // Clear old data first for a clean import
